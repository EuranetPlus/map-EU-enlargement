export const config = {
  "mapTitle": "EU enlargement status", // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
  "vercelURL": "map-eu-enlargement.vercel.app", // The url provided when deploying the map on Vercel
